...
class CourseController extends Controller
{
    ...
    public function course_details($slug)
    {
        ...
        ->select('id', 'name', 'slug', 'sku', 'course_online_payment', 'description', 'browser', 'meta_title', 'meta_description', 'meta_keywords', 'image','banner_image', 'tag_line','about','course_free','singapore_price','us_price','dubai_price','price', 'course_duration', 'career_roles', 'eligibility') // load only needed course fields
        ->where('slug', $slug)
        ->firstOrFail();
