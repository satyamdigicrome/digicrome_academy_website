    ...
    <div id="placementformModal" class="modal" id="mm">
        <div class="modal-content">
            <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:10px;">
                ...
                <span onclick="closePlacementModal()" style="font-size:22px; cursor:pointer; color:#fff;">&times;</span>
            </div>
            <p style="font-size:14px; color:#fff; margin-bottom:15px;">Filled this form below</strong><br>Need help? Call us at
                <strong>01204538104
            </p>
