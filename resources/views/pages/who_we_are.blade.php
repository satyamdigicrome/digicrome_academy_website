               ...
               <b> Global IT Upskilling<br> Edtech  </b>           
                ...
                Platform. By providing top-tier mentorship and tech-driven programs
                 ...
                 ability to excel in the IT Sector job market.
                     ...
                     <a href="https://digicrome.com/our-courses/postgraduate-and-master-programs" class="btn2 btn-warning"><i class="bi bi-whatsapp"></i>Explore Courses</a>
                    <a href="https://digicrome.com/#ajax-form" class="btn1 btn-warning"><i class="bi bi-telephone-fill"></i>Apply For Counselling</a>
                    
                    
            </div>
            <div id="teem" class="col-lg-6 col-md-12"style="padding-left: 10%;" >
                <img src="https://digicrome.com/public/www/seoimg/tools1.webp" alt="digicrome_tools"  style=" border-radius: 3%; height:338px; width:345px;">
            </div>
        </div>
    </div>
...
<ul class="ul1" style="padding-top: 40px;">
    <li style="--accent-color:#28a745">
        ...
        <div class="descr">Awarded 2024 'Best Online Academy of the Year' for Data Science & AI in Delhi NCR, recognizing excellence in online education and commitment to student success.</div>
    </li>
    <li style="--accent-color:#4285f4">
        <div class="date">2023</div>
        <div class="title1"></div><br><br>
        <div class="descr">Excellency Award Winner for best Company of the year 2023.Touched the milestone of running 100+ live batches (online + classroom) per year.</div>
    </li>
    <li style="--accent-color:#ea4335">
        <div class="date">2022</div>
        <div class="title1"></div><br><br>
        <div class="descr">Digicrome expanded its global reach, introducing a groundbreaking course, "Data Science with AI," in over 60 countries. The exceptional quality of our education earned us the prestigious Gold Winner Academy Trophy in recognition of our achievements.</div>
    </li>
    <li style="--accent-color:#f49e1e">
        <div class="date">2021</div>
        <div class="title1"></div><br><br>
        <div class="descr">Touched the 5000+ learner base and introduced 5 new career programs, all while establishing a global presence for the institute in the same year.</div>
    </li>
    <li style="--accent-color:#28a745">
        <div class="date">2020</div>
        <div class="title1"></div><br><br>
        <div class="descr">Amid the COVID-19 pandemic, we launched online courses in the United States in 2020 Digicrome expanded its global footprint by launching a new branch in the United States while maintaining its commitment to educational services in India.</div>
    </li>
    <li style="--accent-color:#4285f4">
        <div class="date">2017</div>
        <div class="title1"></div><br><br>
        <div class="descr">The concept of DigiCrome took shape, and the establishment of DigiCrome's first Branch was initiated in September 2017, in India.</div>
    </li>
</ul>
</section>
...
<section class="company-form contactpage-form" style="padding-top: 50px;" id="map1">
    <div class="title">
        <h1>Stay Ahead with the Support of our Learner Community</h1>
        <h5 style="border: 2px solid #f29c12; border-radius: 30px; display: inline-block; padding:5px;"><b> &nbsp; You Also Include Yourself &nbsp;</b></h5>
    </div>
    <div class="map">
    ...
    <div class="title">
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-12" style="padding-left: 10%;">
                ...
                Our graduates secure positions with salaries that, on average, exceed the industry standard by an impressive 60%.
            ...
            <div id="teem" class="col-lg-6 col-md-12"style="padding-left: 10%; padding-top:20px;" >
                <img src="https://digicrome.com/public/www/seoimg/img121.webp" alt="digicrome_Image"  style="box-shadow: 5px 5px 10px rgba(21, 0, 0, 83.2); border-radius: 3%; height:318px; width:325px;">
            </div>
        </div>
    </div>
...
<section class="company-form contactpage-form" style="background-color: white;">
    ...
    <div class="title">
        ...
        <img src="https://digicrome.com/public/www/seoimg/report.webp" alt="digicrome_report" style="border-radius: 3%; box-shadow: 5px 5px 10px rgba(21, 0, 0, 7.2); height: 338px; width: 345px;">
            </div>
