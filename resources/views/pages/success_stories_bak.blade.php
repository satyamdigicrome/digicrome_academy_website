...
@section('content')
            ...
            <div class="breadcumb-content">
                <div class="breadcumb-title">
                    ...
                    <p style="font-size: 1.2rem; margin-bottom: 25px; line-height: 1.6;">
                        Discover how our students transformed their careers with Digicrome's expert-led programs, real-world
                        projects, and lifelong mentorship.
                    </p>

                    <ul
                        style="list-style: none; padding: 0; margin-bottom: 25px; font-size: 1rem; line-height: 1.8; text-transform: capitalize;">
                    ...
                    <a href="#stories"
                        style="padding: 12px 25px; background-color: #f29c12; color: white; text-decoration: none; font-weight: bold; border-radius: 4px;">
    ...
    <section class="py-5 bg-white">
        <div class="container">
            <div class="breadcumb-title">
                <h2 class="display-5 fw-bold text-center">Meet Our Champions</h2><br>
            </div>
            <div class="row g-4">
                @foreach ($studentStories as $story)
                    <div class="col-md-6 col-lg-4">
                        <div class="card h-100 shadow-sm border-0 rounded-4 text-center p-4">
                            <img loading="lazy" src="{{ asset('storage/' . $story->image) }}" alt="Student Photo"
                                title="Student Photo" class="rounded-circle mx-auto mb-3"
