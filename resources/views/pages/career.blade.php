                ...
                <span style="text-align: justify; font-size: 18px; color: white; font-family:arial;">
                    ...
                    <br>objectives. Since our establishment in 2018, Digicrome has made a significant
                     ...
                     <br> If this resonates with your aspirations, we warmly welcome you to 
                      ...
                      <br><br><br>
                      <button class="custom-button" style="background-color: white; color:black;"> Explore open position</button>
                        <br><br><br>
                       <p style="color: white;"> <strong>Disclaimer:</strong>Digicrome in no way encourages any recruitment fee from the candidates.

Beware of the fraud recruitment offers.</p>
            </div>
            <div id="teem" class="col-lg-6 col-md-12" style="padding-top: 70px;">
                <img src="https://digicrome.com/public/www/seoimg/1d.webp" alt="Image"  style="float: right; border-radius: 3%;">
            </div>
        </div>
    </div>
...
<section class="company-form contactpage-form" style="padding-top: 50px;">
    <div class="container-fluid" style="color: white; padding-left: 50px; padding-right: 50px;">
    <h1 class="section__title"  style="text-align: center; padding-bottom:40px;"><b>Unveiling <span class="yellow-bg"> Digicrome<img src="https://digicrome.com/public/www/assets/img/shape/yellow-bg-2.png" alt="digicrome_png"></span> Distinct Culture</b></h1>
        <div class="row">
            <div class="col-lg-4 col-md-12 text-center" style="padding-top: 30px;">
                <div>
                <img src="https://digicrome.com/public/www/seoimg/1e.webp" alt="digicrome_Image" style="width: 110px; height: 110px; border-radius: 5%; background-color:orange;">
                    <h4 style="padding-top:20px; ">Building Outstanding Careers</h4>
                    <p style="padding-left: 50px; padding-right:50px; font-size: 1rem; font-weight: 400;line-height: 1.8; ">If you want to create an outstanding career instead of just getting a job, Digicrome is the perfect place for you. We consistently help our team members embark on exciting career paths.</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-12 text-center" style="padding-top: 30px;">
                <div>
                    <img src="https://digicrome.com/public/www/seoimg/1f.webp"  alt="digicrome_Image" style="width: 110px; height: 110px; border-radius: 5%; background-color:orange;">
                    <h4 style="padding-top:20px; ">Empowering Women at Work</h4>
                    <p style="padding-left: 50px; padding-right:50px; font-size: 1rem; font-weight: 400;line-height: 1.8; ">We are dedicated to creating a workplace that welcomes diversity and offers policies that empower women to pursue their dreams and make a positive impact through their work.</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-12 text-center" style="padding-top: 30px;">
                <div>
                <img src="https://digicrome.com/public/www/seoimg/1g.webp" alt="digicrome_Image" style="width: 110px; height: 110px; border-radius: 5%; background-color:orange;">
                    <h4 style="padding-top:20px; ">Enjoying Fun with Responsibility</h4>
                    <p style="padding-left: 50px; padding-right:50px; font-size: 1rem; font-weight: 400;line-height: 1.8; ">At Digicrome, we believe in having fun and enjoyment in every moment and lightheartedness. Yet, we also remain steadfast in our commitment to our global responsibilities.</p>
                </div>
            </div>
        </div>
    </div>
...
<section class="company-form contactpage-form" style=" padding-top:10px;">
    ...
    <section class="company-form contactpage-form" style="padding-top: 10px;">
    <div class="container-fluid" style="color: white; padding-left: 50px; padding-right: 50px;">
    <h1 class="section__title"  style="text-align: center;"><b>Why <span class="yellow-bg"> learn<img src="https://digicrome.com/public/www/assets/img/shape/yellow-bg-2.png" alt=""></span> through</b><b style="color:orange;"> Digicrome?</b></h1>
        <div class="row">
            <div class="col-lg-4 col-md-12 text-center" style="padding-top: 70px;">
                <div>
                <img src="https://digicrome.com/public/www/seoimg/3c.webp" alt="Image" style="width: 110px; height: 110px; border-radius: 50%; background-color:orange;">
                    <h4 style="padding-top:20px;  ">Develop Future-Ready Skills</h4>
                    <p style="padding-left: 50px; padding-right:50px; font-size: 1rem; font-weight: 400;line-height: 1.8; ">We design courses to help learners build skills that they can apply immediately to their jobs. You will derive insights from your program to prepare for the future of work and advance your career.</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-12 text-center" style="padding-top: 70px;">
                <div>
                    <img src="https://digicrome.com/public/www/seoimg/3a.webp"  alt="Image" style="width: 110px; height: 110px; border-radius: 50%; background-color:orange;">
                    <h4 style="padding-top:20px;  ">Learn from the Best</h4>
                    <p style="padding-left: 50px; padding-right:50px; font-size: 1rem; font-weight: 400;line-height: 1.8; ">We work with top Data Scientist worldwide to develop programs across industries. Leveraging insights from faculty who are world-leading practitioners in their fields, we develop courses from the ground up to craft high-quality learning experiences.</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-12 text-center" style="padding-top: 70px;">
                <div>
                <img src="https://digicrome.com/public/www/seoimg/3b.webp" alt="Image" style="width: 110px; height: 110px; border-radius: 50%; background-color:orange;">
                    <h4 style="padding-top:20px;  ">Gain a Global Perspective</h4>
                    <p style="padding-left: 50px; padding-right:50px; font-size: 1rem; font-weight: 400;line-height: 1.8; ">With our Asia top Trainer and global faculty, you will learn alongside others from around the world who work in diverse industries, allowing for a cross-cultural exchange of ideas.</p>
                </div>
            </div>
        </div>
    </div>
...
<h1 style="text-align: center; font-family: Open Sans,sans-serif; padding-bottom:20px;"><b>24X7<span style="color: #f29c12;"> Learner’s</span> Support</b></h1>
        ...
        <div class="row">
            <div class="col-lg-6 col-md-12 " style="padding-top: 50px;">
                <div style="padding-top: 20%;">
                    ...
                    <p style="font-weight: 400;font-size: 18px;color: #0072bc;margin: 0 0 30px;">Reach out to us and your career guide will get in touch with you shortly</p>
                    <a href="https://api.whatsapp.com/send/?phone=01203133869&text&type=phone_number&app_absent=0" class="btn2 btn-warning"><i class="bi bi-whatsapp"></i> Enquire Now</a>
                    <button type="button" class="btn1 btn-warning"><i class="bi bi-telephone-fill"></i>01203133869</button>

                </div>
            </div>
            <div class="col-lg-6 col-md-12 text-center" style="padding-top: 40px;">
                <div>
                    <img src="https://digicrome.com/public/www/seoimg/3d.webp" alt="digicrome_support" style="width: 100%px; height:100%;">
                </div>
            </div>
        </div>
    </div>
...
<h1 style="text-align: center; font-size:1.7rem; font-family: Open Sans,sans-serif; padding-bottom:20px;"><b>24X7<span style="color: #f29c12;"> Learner’s</span> Support</b></h1>

    <div class="container-fluid2" style="background-image: url(https://supplier-prod-temp-files.s3.ap-southeast-1.amazonaws.com/products-upload/cataloging/1697693715218/Untitleddesign26.png);">
        <div class="row">
            <div class="col-lg-6 col-md-12 " style="padding-top: 50px;">
                <div style="padding-top: 20%;">
                    ...
                    <p style="font-weight: 400;font-size: 18px;color: #0072bc;margin: 0 0 30px;">Reach out to us and your career guide will get in touch with you shortly</p>
                    <a href="https://api.whatsapp.com/send/?phone=918595746168&text&type=phone_number&app_absent=0" class="btn2 btn-warning"><i class="bi bi-whatsapp"></i> Enquire Now</a>
                    <button type="button" class="btn1 btn-warning"><i class="bi bi-telephone-fill"></i> +91-8595746168</button>

                </div>
            </div>
            <div class="col-lg-6 col-md-12 text-center" style="padding-top: 40px;">
                <div>
                    <img src="https://digicrome.com/public/www/seoimg/3e.webp" alt="digicrome_support" style="width: 100%; height:100%; border-radius: 7px">
                </div>
            </div>
        </div>
    </div>
    <style>
        @media (min-width: 768px) {
            ...
            .company-form2 {
                display: none; /* Hide the entire section on desktop screens */
            }
        }
       @media (max-width: 767px) {
    .container-fluid2 {
        border-radius: 8px;
        padding: 12px; /* Remove negative padding values */
        display: block;
        border-radius: 10px;
        height: 716px; /* Allow the height to adjust automatically based on content */
        justify-content: space-evenly;
        background-position: center; /* Center the background image */
        background-size: cover; /* Scale the background image to cover the container */
        background-repeat: no-repeat;
        margin: 20px 8px; /* Adjust the margin as needed */
    }
}
@media (max-width: 767px) {
        #have2{
