...
<section class="py-5 text-center bg-light">
    <div class="container">
      ...
      <div class="d-flex flex-wrap justify-content-center align-items-center">
        <img src="https://upload.wikimedia.org/wikipedia/commons/6/64/Times_Network_Logo.png" class="media-logo" alt="Times">
        <img src="https://upload.wikimedia.org/wikipedia/commons/3/35/India_Today_Group_Logo.png" class="media-logo" alt="India Today">
        <img src="https://upload.wikimedia.org/wikipedia/commons/e/e4/Zee_News_logo.svg" class="media-logo" alt="Zee News">
