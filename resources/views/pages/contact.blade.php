...
<div id="main">
	...
	<h2 class="text-center mb-2" style="font-size: 2rem; margin-top: 15px;">
		Contact Digicrome <span style="color: #f29c12;">Support</span> at  01204538124 / +91 6299 611 702
	</h2>
...
<input type="hidden" name="ib" value="">
	...
	`;
				...
				<div class="row mt-4">
					<div class="col-md-4">
						<div class="info-box">
							...
							<p><i class="fas fa-phone"></i> 01204538124</p>
		...
		<div class="info-box">
			...
			<p><i class="fas fa-phone"></i> 01204538124 <br><small>Available: 11 AM to 6 PM</small></p>
