             ...
             <div class="row">
                 <div class="col-lg-6 col-12">
                     <div class="course-heading-banner col-flex">
                         ...
                         <img loading="lazy" src='{{ asset('assets/images/ds-withai-course/mslogo.png') }}' alt="Microsoft Logo" class='ds-logo lazyload'>
                         <div class="black-box">
         ...
         <div class="container">
             <div class="banner-detail">
                 <div class="date-border width">
                    ...
                    border: 2px solid;">
                         <a id="downloadBrochureBtn" onclick="openModal('leadPopup')" download=""
